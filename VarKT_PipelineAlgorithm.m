function [anom_list,data_subpl,fitresult,time2run,outlierProps,kTPredictor,MaskVol,PathLength] = VarKT_PipelineAlgorithm(fileloc,Choices,INFO,kT)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
reThreshIters = 0; %Rethreshold iterations. Integers of 0 and above. Might stall out with more than 2 or higher.
...
RefineIA = 0; %Switch to use mask refinement (1 = yes, 0 = no)
...
for i=1:length(Images)
    ...
    [anom_list,data_subpl,fitresult,blanks{i},blankp{i},blankd{i},blankdiam{i},outlierProps] = AnomalyDetection(Images{i},data_pl{i},blanks{i},blanki{i},...

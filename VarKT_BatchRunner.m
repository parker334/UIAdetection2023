function batch_results = VarKT_BatchRunner(start_index,batch_size,kT)
% Initialize results
...
for i = 1:batch_size
    ...
    [anom_list, data_subpl,fitresult,time2run,outlierProps,KwPredictor,MaskVol,PathLength] = VarKT_PipelineAlgorithm(fileloc,DICOMnum,INFO,kT);
    anom_list
    if size(anom_list) ~= 0
        batch_results(i) = 1;
    end
